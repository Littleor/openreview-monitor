...
import { Loader2, ArrowLeft, Check, User, Lock } from 'lucide-react'
  ...
  if (step === 'input') {
    return (
      <Card className="w-full max-w-lg">
        <CardHeader>
          <CardTitle>Monitor a Paper</CardTitle>
          <CardDescription>
            Enter an OpenReview paper URL to start monitoring
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handlePreview} className="space-y-4">
            ...
            <div className="border rounded-lg p-4 space-y-4 bg-muted/30">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>OpenReview Credentials (for private papers)</span>
              </div>
              <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Required for papers that are not publicly visible. Your credentials are securely stored.
              </p>
            </div>
      ...
      <Card className="w-full max-w-lg">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle>Confirm Paper Details</CardTitle>
              <CardDescription>
